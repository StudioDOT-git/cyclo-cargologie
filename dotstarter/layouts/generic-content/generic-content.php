                    ...
                    <?php while (have_rows('content')):
                        ...
                        <?php switch (get_row_layout()):
                            case 'title':
                                ...
                                break;
                            case 'text': ?>
                                <div class="generic-content-text c-wysiwyg">
                                    <?php the_sub_field('text'); ?>
                                </div>
                                <?php break;
                            case 'text-en': ?>
                                <div class="generic-content-text-en c-wysiwyg">
                            ...
                            case 'slider':
                                ...
                                <div class="f-generic-content__slider-wrapper">
                                    <div class="generic-gallery f-generic-content__slider <?= $is_large ? 'is-large' : '' ?>">
                                        ...
                                        while (have_rows('columns')):
                                            ...
                                            <div class="generic-columns__column">
                                                ...
                                                <?php if (get_sub_field('text')): ?>
                                                    <p class="generic-columns__text c-wysiwyg">
                                                        <?php the_sub_field('text'); ?>
                                                    </p>
                                                <?php endif; ?>
                                            </div>
