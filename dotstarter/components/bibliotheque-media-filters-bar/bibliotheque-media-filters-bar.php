...
$taxonomies = array(
    array(
        'label' => 'Type de média',
        'slug' => 'media_category',
        'terms' => get_terms(['taxonomy' => 'media_category', 'hide_empty' => true]),
        ...
        <div class="c-filters-bar">
            ...
            <div class="c-filters-bar__filters">
                ...
                <div class="c-filters-bar__filters-search">
                    <form id="c-filters-bar-search-form"
                        class="c-filters-bar-search-form c-bibliotheque-media-search-form">
