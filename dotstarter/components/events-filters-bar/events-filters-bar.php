    ...
    <div class="l-container">
        <div class="c-filters-bar">
            <div class="c-filters-bar__left">
                ...
                <div class="c-filters-bar__filters">
                    <?php foreach ($taxonomies as $tax) : ?>
                        <div class="c-multi-filter c-multi-filter--whitec-events-filters-bar__select c-multi-terms-selector" data-taxonomy="<?= $tax['slug'] ?>">
                            ...
                            <div class="c-multi-filter__options">
                                <?php foreach ($tax['terms'] as $term) : ?>
                                    <div class="c-multi-filter__option" data-slug="<?= $term->slug ?>"
                                        data-id="<?= $term->term_id ?>"><?= $term->name ?></div>
                                <?php endforeach; ?>
                            </div>
                        </div>
                    <?php endforeach; ?>
            ...
            <div class="c-filters-bar__right">
                <form id="events-search-form" class="c-filters-bar-search-form c-events-search-form">
